...
namespace MathFacts
{
    class Subtraction
    {
        public void SubtractTable()
        {
            Console.Clear();
            Console.ForegroundColor = ConsoleColor.Red;
            string appTitle = @" ___                                              _               
|           |       |                       |                     
 -+-        |-     -+-  |-     -     -     -+-    +    -    |-    
    | | |   | |     |   |     | |   |       |     |   | |   | |   
 ---   --    -       -         --    -       -         -          
 ...
 ___                          
  ...
  |   | |   | |     |   |/    
       --    -      -    --    ";
            ...
            Console.WriteLine("Next you will see the numbers between these selections subtracted");
            Console.WriteLine("to numbers 1 - 10");
            Console.WriteLine("");
            Console.WriteLine("Select a starting number between 1 and 10");
        }

        public void SubtractChart(int startNum, int endNum)
        {
